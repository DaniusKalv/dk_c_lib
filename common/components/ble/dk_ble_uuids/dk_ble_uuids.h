...
#define DK_BLE_UUID_PHIL_IT_UP_AMB_TMP_CHARACTERISTIC   0xFD99  /**< Phil It Up ambient temperature characteristic UUID. */
#define DK_BLE_UUID_PHIL_IT_UP_MUG_TMP_CHARACTERISTIC   0xFD9A  /**< Phil It Up mug temperature characteristic UUID. */
