...
#define DK_BLE_UUID_BASE                                                                                               \
    {                                                                                                                  \
        {                                                                                                              \
            0x8F, 0x02, 0xED, 0x3E, 0x20, 0xE9, 0x4F, 0x60, 0xB1, 0x7A, 0xA4, 0x78, 0x1B, 0x33, 0x43, 0x01,            \
        }                                                                                                              \
    } // 128-bit base UUID
...
#define DK_BLE_UUID_PHIL_IT_UP_AMB_TEMP_CHARACTERISTIC                                                                 \
    0xFD99                                    /**< Phil It Up ambient temperature characteristic UUID. */
...
#define DK_BLE_UUID_PHIL_IT_UP_TARGET_TEMP_CHARACTERISTIC                                                              \
    0xFD9C                                                    /**< Phil It Up target temperature characteristic UUID. */
