...
#define ORG_BLUETOOTH_UNIT_THERMODYNAMIC_TEMPERATURE_DEGREE_CELSIUS                                                    \
    0x272F /**< Bluetooth unit celsius code as provided by Bluetooth SIG.*/
...
#define DK_BLE_PHIL_IT_UP_DEF(_name)                                                                                   \
    ...
    NRF_SDH_BLE_OBSERVER(_name##_obs, DK_BLE_PHIL_IT_UP_OBSERVER_PRIO, dk_ble_phil_it_up_on_ble_evt, &_name)
