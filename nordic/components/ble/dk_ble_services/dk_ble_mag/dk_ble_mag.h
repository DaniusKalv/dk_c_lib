...
#define DK_MAG_RAW_CHARACTERISTIC_VALUE_SIZE    6 // Magnetometer raw characteristic value size in bytes. (3 axis) * 2 bytes
...
NRF_SDH_BLE_OBSERVER(_name ## _obs,             \
                     DK_BLE_MAG_OBSERVER_PRIO,  \
                     dk_ble_mag_on_ble_evt,     \
                     &_name)
