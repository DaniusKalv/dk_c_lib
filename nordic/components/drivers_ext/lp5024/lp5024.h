...
#define LP5024_TWI_BUFFER_SIZE                                                                                         \
    7 /**< Size of a twi TX buffer, maximum amount of registers to be accessed in one TX operation. */
 ...
 * @param[in]   broadcast       Initialize using broadcast address. Can be used to initialize multiple devices with one
 * function call.
 ...
 *
 * @param[in]   p_lp5024            Pointer to LP5024 instance.
 * @param[in]   broadcast           Use broadcast address. Can be used to write to multiple devices with one function
 * call.
 * @param[in]   led                 LED to process.
 ...
 * @retval      Other               Error codes returned by internal functions.
 */
ret_code_t lp5024_set_led_color(lp5024_t      *p_lp5024,
                                bool           broadcast,
                                lp5024_led_t   led,
                                lp5024_color_t color,
