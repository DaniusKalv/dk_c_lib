...
static ret_code_t tlv320aic3106_page_select_set(tlv320aic3106_t *p_tlv320aic3106, tlv320aic3106_active_page_t page);
...
static void twi_mngr_callback(ret_code_t result, uint8_t evt, dk_twi_mngr_transfer_t *p_transfer, void *p_user_data)
{
    ...
    tlv320aic3106_evt_t event = {.p_tlv320aic3106 = p_tlv320aic3106};
    ...
    } else
    {
        ...
        switch (evt)
        {
            case TLV320AIC3106_EVT_TYPE_RX_MODULE_PWR_STATUS:
                ...
                event.params.p_module_pwr_status =
                  (tlv320aic3106_module_pwr_status_t *)p_transfer->transfer_description.p_secondary_buf;
                break;
            default:
                return;
        }
...
static inline ret_code_t set_reg_page(tlv320aic3106_t *p_tlv320aic3106, uint8_t *p_reg_address)
{
                            ...
                            uint8_t                    write_size)
{
    ...
    return dk_twi_mngr_schedule(p_tlv320aic3106->p_dk_twi_mngr_instance, &twi_transaction);
}
...
{
    dk_twi_mngr_transaction_t twi_transaction = {.callback    = twi_mngr_callback,
                                                 .p_user_data = (void *)p_tlv320aic3106,
                                                 .event_type  = evt_type,
...
static ret_code_t twi_write_blocking(tlv320aic3106_t const     *p_tlv320aic3106,
                                     ...
                                     uint8_t                    write_size)
{
    dk_twi_mngr_transfer_t twi_transfer = DK_TWI_MNGR_TX(p_tlv320aic3106->i2c_address, p_twi_write, write_size, 0);

    return dk_twi_mngr_perform(p_tlv320aic3106->p_dk_twi_mngr_instance, &twi_transfer, wait_for_transfer_complete);
}

static ret_code_t tlv320aic3106_page_select_get(tlv320aic3106_t *p_tlv320aic3106, tlv320aic3106_active_page_t *p_page)
{
...
static ret_code_t tlv320aic3106_page_select_set(tlv320aic3106_t *p_tlv320aic3106, tlv320aic3106_active_page_t page)
{
    ...
    err_code = twi_write(p_tlv320aic3106, p_page_data, p_page_data_size);
    VERIFY_SUCCESS(err_code);
...
ret_code_t tlv320aic3106_soft_rst(tlv320aic3106_t *p_tlv320aic3106)
{
    ...
    tlv320aic3106_twi_write_t twi_write = {.reg_address = TLV320AIC3106_SOFT_RST,
                                           .data[0]     = TLV320AIC3106_SOFT_RST_VAL};

    err_code = twi_write_blocking(p_tlv320aic3106, &twi_write, 2);
                                                           ...
                                                           tlv320aic3106_passive_ana_sig_bypass_sel_pd_t *p_bypass)
{
    ...
    DK_TWI_MNGR_BUFF_ALLOC(tlv320aic3106_twi_write_t,
                           p_bypass_cmd,
                           sizeof(tlv320aic3106_passive_ana_sig_bypass_sel_pd_t));
...
{
    tlv320aic3106_passive_ana_sig_bypass_sel_pd_t ana_sig_bypass =
      p_tlv320aic3106->config.passive_ana_sig_bypass_sel_pd;
...
{
    tlv320aic3106_audio_codec_overflow_flag_t overflow_reg = {.pll_r = pll_r};
