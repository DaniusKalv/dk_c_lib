...
typedef enum
{
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_1  = 0x01, /**< 1 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_2  = 0x02, /**< 2 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_3  = 0x03, /**< 3 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_4  = 0x04, /**< 4 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_5  = 0x05, /**< 5 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_6  = 0x06, /**< 6 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_7  = 0x07, /**< 7 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_8  = 0x08, /**< 8 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_9  = 0x09, /**< 9 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_10 = 0x0A, /**< 10 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_11 = 0x0B, /**< 11 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_12 = 0x0C, /**< 12 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_13 = 0x0D, /**< 13 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_14 = 0x0E, /**< 14 DCLK */
    SH1106_DIS_PRE_CHARGE_PERIOD_DCLK_15 = 0x0F  /**< 15 DCLK */
} sh1106_dis_pre_charge_period_t;

typedef struct
{
    sh1106_dis_pre_charge_period_t pre_charge : 4; /**< Pre-charge period. */
    sh1106_dis_pre_charge_period_t discharge  : 4; /**< Discharge period. */
} sh1106_dis_pre_charge_t;
...
#define SH1106_DEF(_name, _p_spi_instance, _rst_pin, _cs_pin, _dc_pin, _width, _height)                                \
    static sh1106_t _name = {.p_spi_instance = _p_spi_instance,                                                        \
                             .reset_pin      = _rst_pin,                                                               \
                             .cs_pin         = _cs_pin,                                                                \
                             .dc_pin         = _dc_pin,                                                                \
                             .width          = _width,                                                                 \
