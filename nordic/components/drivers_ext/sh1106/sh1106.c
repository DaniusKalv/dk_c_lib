...
ret_code_t sh1106_init(sh1106_t *p_sh1106)
{
    ...
    sh1106_clk_freq_t clk_freq = {.osc_freq = SH1106_OSC_FREQ_15, .clk_div = 0};
...
ret_code_t sh1106_set_column_address(sh1106_t *p_sh1106, uint8_t column_address)
{
    ...
    uint8_t column_address_cmd[] = {(SH1106_CMD_COLUMN_ADDRESS_LOW | (column_address & SH1106_COLUMN_ADDRESS_MASK)),
...
{
    uint8_t contrast_cmd[] = {SH1106_CMD_CONTRAST, contrast};
...
ret_code_t sh1106_set_multiplex_ratio(sh1106_t *p_sh1106, uint8_t ratio)
{
    ...
    uint8_t multiplex_ratio_cmd[] = {SH1106_CMD_MULTIPLEX_RATIO, ratio};
...
{
    uint8_t dc_dc_cmd[] = {SH1106_CMD_DC_DC_OFF_ON_CTRL, SH1106_CMD_DC_DC_OFF_ON | on};
...
ret_code_t sh1106_set_display_offset(sh1106_t *p_sh1106, uint8_t offset)
{
    ...
    uint8_t display_offset_cmd[] = {SH1106_CMD_DISPLAY_OFFSET, offset};
...
{
    uint8_t clk_freq_cmd[sizeof(SH1106_CMD_CLK_FREQ) + sizeof(sh1106_clk_freq_t)] = {SH1106_CMD_CLK_FREQ};
...
{
    uint8_t com_pads_hw_config_cmd[] = {SH1106_CMD_COM_PADS_HW_CONF_CTRL,
...
{
    uint8_t vcom_des_lvl_cmd[] = {SH1106_CMD_VCOM_DES_LVL, level};
