...
NRF_SECTION_ITEM_REGISTER(dk_uicr_hw_info, dk_uicr_hw_info_t dk_uicr_hw_info) = {.hw_id = HW_ID, .hw_v = HW_VERSION};
...
NRF_SECTION_ITEM_REGISTER(dk_uicr_regout0, dk_uicr_regout0_t dk_uicr_regout0) = {.vout = DK_UICR_REGOUT0};
